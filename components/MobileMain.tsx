  ...
  return (
    <div className="mobile--main">
      ...
      <div className="info--bio">
        ...
        <p>
          Lorem ipsum dolor sit amet, consectetur adipisicing Officiis ducimus,
          magni tempore impedit facilis cupiditate aspernatur voluptatem ea
          quidem officia
          ...
          <span className={seeMore ? "see--more" : "see--less"}>
            ...
            aliquam dolorem tenetur, pariatur commodi inventore. Hic, quibusdam.
            Hic reiciendis maiores quibusdam.
          </span>
